...
<table style="width: 100%; border-collapse: collapse; margin-bottom: 20px;">
  <tr><td style="padding: 8px 0; font-weight: bold; width: 40%;">Roommate Names:</td><td style="padding: 8px 0;">${escapeHtml(data["Roommate names"] || "None Provided")}</td></tr>
  <tr><td style="padding: 8px 0; font-weight: bold;">NBA Purchase Flight:</td><td style="padding: 8px 0;">${data["Pref: NBA purchase flight directly"] === "on" ? "Yes – requested" : "No"}</td></tr>
  <tr><td style="padding: 8px 0; font-weight: bold;">Announcement Consent:</td><td style="padding: 8px 0;">${escapeHtml(data["Announcement consent"] || "Not provided")}</td></tr>
  <tr><td style="padding: 8px 0; font-weight: bold;">Special Considerations:</td><td style="padding: 8px 0;">${escapeHtml(data["Additional considerations"] || "None")}</td></tr>
</table>
